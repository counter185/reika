...
{
    public partial class WindowCreateFile : Window, ICreateFileSession
    {
        ...
        void CreateStreamsList()
        {
            ...
            foreach (var stream in streamTargets)
            {
                ...
                LinuxUtils.AddRightMouseButtonDownHandler(streamEntry, () =>
                {
        ...
        private void Button_VcodecSelect_Click(object sender, RoutedEventArgs e)
        {
            ...
            LinuxUtils.ShowDialog(pickEnc, this);
